...
keymap.set('n', '<leader>fg', telescope_builtin.live_grep, {desc = "Live grep"})
keymap.set('n', '<leader>fb', telescope_builtin.buffers, {desc = "Find buffers"})
keymap.set('n', '<leader>fh', telescope_builtin.help_tags, {desc = "Help tags"})
keymap.set('n', '<leader>fs', telescope_builtin.current_buffer_fuzzy_find, {desc = "Current buffer fuzzy finder"})
...
keymap.set('n', '<leader>fd', telescope_builtin.lsp_definitions, {desc = "LSP definitions"})
keymap.set('n', '<leader>fm', function() telescope_builtin.treesitter({default_text=":method:"}) end, {desc = "Find method"})
