...
keymap.set("n", "<leader>h1", function() require("harpoon.ui").nav_file(1) end, {desc = "Harpoon navigate file 1"})
keymap.set("n", "<leader>h2", function() require("harpoon.ui").nav_file(2) end, {desc = "Harpoon navigate file 2"})
keymap.set("n", "<leader>h3", function() require("harpoon.ui").nav_file(3) end, {desc = "Harpoon navigate file 3"})
keymap.set("n", "<leader>h4", function() require("harpoon.ui").nav_file(4) end, {desc = "Harpoon navigate file 4"})
keymap.set("n", "<leader>h5", function() require("harpoon.ui").nav_file(5) end, {desc = "Harpoon navigate file 5"})
keymap.set("n", "<leader>h6", function() require("harpoon.ui").nav_file(6) end, {desc = "Harpoon navigate file 6"})
keymap.set("n", "<leader>h7", function() require("harpoon.ui").nav_file(7) end, {desc = "Harpoon navigate file 7"})
